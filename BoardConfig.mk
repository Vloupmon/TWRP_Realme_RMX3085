...
# Assert
TARGET_OTA_ASSERT_DEVICE := oppo6785

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 52963328 # This is the maximum known partition size, but it can be higher, so we just omit it
